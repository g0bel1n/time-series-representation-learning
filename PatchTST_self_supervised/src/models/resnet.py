...
class ResNetBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels=64, stride=1):
        ...
        self.conv1 = nn.Conv1d(in_channels, out_channels, kernel_size=8, stride=stride, padding=1, bias=False)
        self.bn1 = nn.BatchNorm2d(out_channels)

        self.conv2 = nn.Conv1d(out_channels, out_channels, kernel_size=5, stride=1, padding=1, bias=False)
        ...
        self.shortcut = nn.Sequential(
            [nn.Conv1d(in_channels, out_channels, kernel_size=1, stride=1, padding=1, bias=False),
...
class ResNet(nn.Module):
    ...
    def __init__(self, in_channels, task: str, num_classes: int, head_dropout: float=0.2):
